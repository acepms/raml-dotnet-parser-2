...
namespace UnitTestProject1
{
    ...
    public class PetStoreJsonTests
    {
        ...
        {
            Assert.AreEqual("MIT", model.License.Name);
        }
        ...
        {
            Assert.AreEqual("Swagger Petstore", model.Name);
        }
        ...
        {
            var get = model.EndPoints.First(e => e.Path == "/pets").Operations.First(o => o.Method == "get");
        ...
        {
            var get = model.EndPoints.First(e => e.Path == "/pets/{petId}").Operations.First(o => o.Method == "get");
